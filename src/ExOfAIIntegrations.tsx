...
import { Bot, Calendar, LineChart, ChevronRight } from 'lucide-react';
        ...
        <div className="space-y-8">
          ...
          <Link to="" className="block">
            <motion.div
              ...
              className="w-full py-8 px-6 bg-white/80 backdrop-blur-sm hover:bg-white/90 hover:shadow-xl transition-all duration-300 rounded-xl border border-gray-200 shadow-lg cursor-pointer group"
            >
