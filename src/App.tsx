        ...
        <div className="container mx-auto px-6 relative z-10 min-h-screen">
          ...
          >
            <div className="px-8 md:px-10 py-6 text-left">
              ...
              >
                <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent mb-2 leading-tight">
                  Increasing Profit.
                </h2>
              </motion.div>
              ...
              >
                <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent mb-4 leading-tight">
                  Reducing Costs.
                </h2>
              </motion.div>
