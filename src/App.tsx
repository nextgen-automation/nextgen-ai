          ...
          >
            <div className="px-8 py-6 text-center">
              ...
              <div className="flex justify-center gap-4">
                <button className="bg-blue-600 hover:bg-blue-700 px-6 py-3 rounded-full transition-colors text-lg font-medium">
                  Book a Meeting
                </button>
                <button className="border border-gray-400 hover:border-white px-6 py-3 rounded-full transition-colors text-lg font-medium">
                  Watch Demo
                </button>
              </div>
            </div>
