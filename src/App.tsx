      ...
      <section className="relative min-h-screen">
        ...
        <div className="container mx-auto px-6 relative z-10 min-h-screen">
          ...
          <motion.div
            ...
            className="absolute top-[-45%] inset-x-0 mx-auto w-[90vw] max-w-md bg-black/70 rounded-2xl overflow-hidden md:top-32 md:left-0 md:translate-x-0 md:translate-y-0"
          >
