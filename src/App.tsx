        ...
        <section className="relative min-h-screen" aria-label="Hero section">
          ...
          <div className="container mx-auto px-6 relative z-10 min-h-screen">
            ...
            <motion.div
              ...
              className="absolute top-20 sm:top-[max(5rem,min(40vh,calc(100vh-24rem)))] inset-x-0 mx-auto w-[90vw] max-w-md bg-black/70 rounded-2xl overflow-hidden md:top-32 md:left-0 md:inset-x-auto md:mx-0 md:w-auto"
            >
